...
def pregunta_01():
    ...
    # Asignar nombres correctos de columnas # Los nombres de las columnas deben ser en minusculas
...
if __name__ == "__main__":
    ...
    # # Las palabras clave deben estar separadas por coma
    # df["principales_palabras_clave"] = df["principales_palabras_clave"].str.replace(r"\s{1,}", " ", regex=True)
